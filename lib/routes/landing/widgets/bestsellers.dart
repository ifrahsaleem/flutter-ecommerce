...
class _BestSellersState extends State<BestSellers> {
  ...
  List<Product> Best_Sellers;
  Future<List<Product>> highestrated() async {
    final response = await http.get(
      Uri.http('cs308canvas.herokuapp.com','/product/bestsellers'),
    ...
    if (response.statusCode == 200) {
      ...
      Best_Sellers = body.map((dynamic item) => Product.fromJson(item)).toList();
      return Best_Sellers;
    } else {
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      SingleProduct(id:Best_Sellers[index].productId),
                                )
                            );
                          },
                          child: Container(
                              ...
                              children: <Widget>[
                                    ...
                                    children: <Widget>[
                                      Center(
                                        child: FadeInImage.memoryNetwork(
                                          ...
                                          image: Best_Sellers[index].onlineImageLink,
                                          height: 90,
                                        ),
                                      )
                                    ],
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: Text(
                                        '${Best_Sellers[index].productName} ',
                                        style: TextStyle(
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          ...
                                          child: CustomText(text:Best_Sellers[index].productRating.toString(), color: Colors.grey, size: 14.0,
                                          ),
                                        ),
                                        SizedBox(width: 2,),
                                      ],
                                    ...
                                    Padding(
                                      ...
                                      child: CustomText(text: "\$${Best_Sellers[index].productPrice}", weight: FontWeight.bold,),
                                    ),
                                  ],
                                ),
                              ],
